...
(function(){
  ...
  if(disciplina == 'portugues'){
    ...
    $('.capaNomeDisciplina').text('arte');
    $('body').addClass("akpalo_fundo_arte");
  ...
  if(infoTemplate == 'tempo'){
	...
	switch(infoTemplate){
		case 'akpalo':
			...
			if( !(disciplina == 'arte' || disciplina == 'portugues' || disciplina == 'matematica' || disciplina == 'historia' || disciplina == 'geografia' || disciplina == 'ciencias') ){
